...
Copyright (C) 2014-2016, 2018, 2020-2021, 2026 MouseHelmet Software
...
EnVar::SetValue      VariableName Path
EnVar::SetValueEx    VariableName Path

  Sets a Path on the specified VariableName. SetValueEx is for expandable paths,
  ie %tempdir%. This overwrites everything in the Path, so be careful about
  specifying the correct VariableName. Note that "path" cannot be overwitten.
